...
mod DepositsAndWithdrawals {
    ...
    impl DepositsAndWithdrawals of super::IDepositsAndWithdrawals<ContractState> {
        fn deposit(ref self: ContractState, amount: u256) {
            ...
            self.deposits.write(caller, current_deposit + amount);
        }
        ...
        fn get_wallet_deposit(self: @ContractState, address: ContractAddress) -> u256 {
            self.deposits.read(address)
        }
    }
...
trait IDepositsAndWithdrawals<TContractState> {
    ...
    fn get_wallet_deposit(self: @TContractState, address: ContractAddress) -> u256;
}
